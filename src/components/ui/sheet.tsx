...
const SheetContent = React.forwardRef<React.ElementRef<typeof SheetPrimitive.Content>, SheetContentProps>(({ side = "right", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    <SheetPrimitive.Content ref={ref} className={cn(sheetVariants({ side }), className)} {...props}>
      <SheetPrimitive.DialogTitle className="sr-only">Sidebar</SheetPrimitive.DialogTitle>
      <SheetPrimitive.Description className="sr-only">toggle sidebar</SheetPrimitive.Description>
